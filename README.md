...
|---|---|
| ![Login Page](evidence/06-login-page.png) | Login page |
| ![Login Request](evidence/07-login-request.png) | Authentication request |
| ![Login Response](evidence/08-login-response.png) | Authentication response |
| ![Session Storage](evidence/09-session-storage.png) | Session/token storage |
